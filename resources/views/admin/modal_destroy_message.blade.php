<div class="modal fade" id="modal_destroy_message" tabindex="-1" role="dialog" aria-labelledby="destroy_ModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="" method="GET" class="form-horizontal" id="delete_form_message">
                            @csrf
                            <button
