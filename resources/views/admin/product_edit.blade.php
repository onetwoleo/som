...
@section('content')
    ...
    <div class="container">
        <div class="product-detail">
            <h1 class="visible-xs visible-sm">Ассорти свиное</h1>
            <div class="row">
                <div class="col-md-6">
                            ...
                            <div class="characteristics">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <a href="{{route('admin')}}"><button class="btn big block">Назад</button></a>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <a data-toggle="modal" data-target="#modal_update_product" data-content="{{ json_encode($product,TRUE)}}" href="#">
                                            <button type="submit" class="btn big block">Изменить</button>
                                        </a>
                                    </div>
                                </div>
                                <hr />
...
{{--                                                                <button type="button" class="btn-number btn-minus" disabled="disabled" data-type="minus" data-field="count-108">-</button>--}}
{{--                                                            </span>--}}
{{--                                                    <input type="text" name="count" id="count-108" class="form-control input-number" value="1" data-min="1" data-max="99999999">--}}
{{--                                                    <span class="input-group-btn">--}}
{{--                                                                <button type="button" class="btn-number btn-plus" data-type="plus" data-field="count-108">+</button>--}}
{{--                                                            </span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <div class="push20"></div>--}}
...
{{--                                    </div>--}}
{{--                                    <div class="col-sm-4 col-md-6 col-lg-4">--}}
{{--                                        <div class="price-wrap f26 weight900"><span class="price">180 руб.</span> <span class="old-price strike gray weight100 f16">210 руб.</span></div>--}}
